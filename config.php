...
$dbss=array();
$dbss['host']='shareddb1e.hosting.stackcp.net';      // Database host (in most cases 'localhost', on Windows systems - use '127.0.0.1' instead of 'localhost' to avoid a php/ipv6 bug)
$dbss['user']='Dabo';      // Database user
$dbss['pass']='LilMicky7';      // Database password
$dbss['name']='Login-Details-3637f210';      // Database name. Note that the installation script cannot create a database for you!
$dbss['sock']='';      // Database socket
$dbss['prfx']='openEDU';      // Table prefix for chat tables: blab, blabws, blabax, blabwspro

$dbss['sprf']='openEDU';      /* Table prefix for shared chat tables (this should be the table prefix of the 'master' channel). 
...
$xcookie_uidhash = array('openEDU_uidhash',31536000);       // cookie to recognize logged in users
$xcookie_options = array('openEDU_options',31536000);       // cookie to store options
$xcookie_ignored = array('openEDU_ignored',172800);         // cookie to store ignored users
$xcookie_message = array('openEDU_annread',31536000);       // cookie to indicate announce (GDPR notice) is read
$xcookie_appcode = array('openEDU_appcode',31536000);       // cookie to BlaB! Q mobile app (integration only!)
